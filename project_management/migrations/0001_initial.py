    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pro_state', models.CharField(choices=[('running', 'RUNNING'), ('apllying', 'APPLYING'), ('apply_passed', 'APPLY_PASSED'), ('abandoned', 'ABANDONED'), ('midterm_checking', 'MIDTERM_CHECKING'), ('done', 'DONE'), ('midterm_passed', 'MIDTERM_PASSED'), ('postponed', 'POSTPONED')], default='running', max_length=10)),
